...
namespace lab_rab_1
{
    public partial class fMain : Form
    {
        ...
        private void bRectangle_Click(object sender, EventArgs e)
        {
            ...
            FigFalse();
            drRect = true;
            bRectangle.BackColor = Color.Tomato;
            curb = bRectangle;
        }
        ...
        private void bEllipse_Click(object sender, EventArgs e)
        {
            ...
            FigFalse();
            drEll = true;
            bEllipse.BackColor = Color.Tomato;
            curb = bEllipse;
        }
        ...
        private void bTriangle_Click(object sender, EventArgs e)
        {
            ...
            FigFalse();
            drPol = true;
            bPolygon.BackColor = Color.Tomato;
            curb = bPolygon;
        }
        ...
        private void bSquare_Click(object sender, EventArgs e)
        {
            ...
            FigFalse();
            drSqu = true;
            bSquare.BackColor = Color.Tomato;
            curb = bSquare;
        }
        ...
        private void bCircle_Click(object sender, EventArgs e)
        {
            ...
            FigFalse();
            drCir = true;
            bCircle.BackColor = Color.Tomato;
            curb = bCircle;
        }
        ...
        private void pbHolst_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                pb.Image = myIm.bmp;
                Bitmap bmp2 = new Bitmap(550, 470);
